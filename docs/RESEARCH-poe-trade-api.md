...
| Max query complexity | **35 units** (anonymous; "Query is too complex" above it — the error text says logging in raises it; observed 2026-08-26 to be at least 116 — saved searches with 2, 3 and 4 `mercenary` groups of 4 filters each all loaded in a logged-in browser) |
