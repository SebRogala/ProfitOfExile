/**
 * Trade API client — desktop edition.
 * Lookups against the GGG trade API via our backend gate.
 * Uses store.status.server_url as the base URL.
 ...
 * Called fresh on every request so it picks up server_url changes.
 */
