							...
							<td class:w-red={isW && color === 'RED'} class:w-green={isW && color === 'GREEN'} class:w-blue={isW && color === 'BLUE'}>
								{#if ev > 0}
									...
									<div class="ded-cost-line">
										...
										<span class="ded-gross" title="Gross font value — what a usage returns before the base gem is paid for. This is your gain only if the base was self-farmed.">{formatPrice(ev, 'divine')}/font gross</span>
									</div>
